...
class BaseAgent(ABC):
    ...
    def _set_router_agent_context(self):
        """Tell the router which agent is making the call (for complexity routing)."""
        from core.models.router import CURRENT_AGENT
        CURRENT_AGENT.set(self.name)
    ...
    async def run(self, record: PipelineRecord) -> PipelineRecord:
        ...
        self._set_router_agent_context()
