...
async def search_records(
    ...
    if tier and hasattr(records[0] if records else None, 'confidence'):
...
async def retry_record(request: Request, record_id: str):
    ...
    from core.pipeline.state import RecordStage, PipelineRecord
    ...
    return {"status": "requeued", "record_id": record_id}
